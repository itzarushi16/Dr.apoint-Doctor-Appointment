...
while (currentDate < endTime) {
  ...
  // increment currentDate (assuming a step increment is needed, but missing in the provided code)
 ...
 setDocSlots(prev=>([...prev,timeSlots]))
  ...
  return docInfo && (
    <div>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 ng-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
